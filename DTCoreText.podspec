Pod::Spec.new do |spec|
  ...
  spec.dependency 'DTFoundation/Core', '~>1.7.18'
  spec.dependency 'DTFoundation/UIKit', '~>1.7.18'
  spec.dependency 'DTFoundation/DTHTMLParser', '~>1.7.18'
  spec.dependency 'DTFoundation/DTAnimatedGIF', '~>1.7.18'
